#ifndef MATHLIB_COLOR_HPP
#define MATHLIB_COLOR_HPP
...
namespace Math {
    ...
    struct Color3 {
        ...
        template<typename U>
        Color3(const Color3<U> &other) : r(static_cast<T>(other.r)), g(static_cast<T>(other.g)),
...
#define EXPR(op) (r op o.r), (g op o.g), (b op o.b)
        MATHLIB_MATH_BINARY_OPS(Color3, Color3, EXPR)
#define EXPR(op)                                                                                                       \
    r op o.r;                                                                                                          \
    g op o.g;                                                                                                          \
    b op o.b
        MATHLIB_MATH_ASSIGN_OPS(Color3, Color3, EXPR)
#define EXPR(op) (r op o), (g op o), (b op o)
        MATHLIB_MATH_BINARY_OPS(Color3, T, EXPR)
#define EXPR(op)                                                                                                       \
    r op o;                                                                                                            \
    g op o;                                                                                                            \
    b op o
        MATHLIB_MATH_ASSIGN_OPS(Color3, T, EXPR)
#undef EXPR
...
#define EXPR(op) (r op o.r), (g op o.g), (b op o.b), (a op o.a)
        MATHLIB_MATH_BINARY_OPS(Color4, Color4, EXPR)
#define EXPR(op)                                                                                                       \
    r op o.r;                                                                                                          \
    g op o.g;                                                                                                          \
    b op o.b;                                                                                                          \
    a op o.a
        MATHLIB_MATH_ASSIGN_OPS(Color4, Color4, EXPR)
#define EXPR(op) (r op o), (g op o), (b op o), (a op o)
        MATHLIB_MATH_BINARY_OPS(Color4, T, EXPR)
#define EXPR(op)                                                                                                       \
    r op o;                                                                                                            \
    g op o;                                                                                                            \
    b op o;                                                                                                            \
    a op o
        MATHLIB_MATH_ASSIGN_OPS(Color4, T, EXPR)
#undef EXPR
    };
