...
#define EXPR(op) (x op o.x), (y op o.y)
        MATHLIB_MATH_BINARY_OPS(Vector2, Vector2, EXPR)
#define EXPR(op)                                                                                                       \
    x op o.x;                                                                                                          \
    y op o.y
        MATHLIB_MATH_ASSIGN_OPS(Vector2, Vector2, EXPR)
#define EXPR(op) (x op o), (y op o)
        MATHLIB_MATH_BINARY_OPS(Vector2, T, EXPR)
#define EXPR(op)                                                                                                       \
    x op o;                                                                                                            \
    y op o
        MATHLIB_MATH_ASSIGN_OPS(Vector2, T, EXPR)
#undef EXPR
...
#define EXPR(op) (x op o.x), (y op o.y), (z op o.z)
        MATHLIB_MATH_BINARY_OPS(Vector3, Vector3, EXPR)
#define EXPR(op)                                                                                                       \
    x op o.x;                                                                                                          \
    y op o.y;                                                                                                          \
    z op o.z
        MATHLIB_MATH_ASSIGN_OPS(Vector3, Vector3, EXPR)
#define EXPR(op) (x op o), (y op o), (z op o)
        MATHLIB_MATH_BINARY_OPS(Vector3, T, EXPR)
#define EXPR(op)                                                                                                       \
    x op o;                                                                                                            \
    y op o;                                                                                                            \
    z op o
        MATHLIB_MATH_ASSIGN_OPS(Vector3, T, EXPR)
#undef EXPR
...
#define EXPR(op) (x op o.x), (y op o.y), (z op o.z), (w op o.w)
        MATHLIB_MATH_BINARY_OPS(Vector4, Vector4, EXPR)
#define EXPR(op)                                                                                                       \
    x op o.x;                                                                                                          \
    y op o.y;                                                                                                          \
    z op o.z;                                                                                                          \
    w op o.w
        MATHLIB_MATH_ASSIGN_OPS(Vector4, Vector4, EXPR)
#define EXPR(op) (x op o), (y op o), (z op o), (w op o)
        MATHLIB_MATH_BINARY_OPS(Vector4, T, EXPR)
#define EXPR(op)                                                                                                       \
    x op o;                                                                                                            \
    y op o;                                                                                                            \
    z op o;                                                                                                            \
    w op o
        MATHLIB_MATH_ASSIGN_OPS(Vector4, T, EXPR)
#undef EXPR
